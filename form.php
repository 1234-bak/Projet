...
<body>
    ...
    <form action="" method="post">
        ...
        <div class="alignement-matiere">
            <label>Matière :</label>
            <input type="checkbox" id="french" name="matiere" value="Fr">
            <label for="french">Français</label>
            <input type="checkbox" id="CD" name="matiere" value="CD">
            <label for="CD">Compression des données</label>
            <input type="checkbox" id="crypto" name="matiere" value="crypto">
            <label for="crypto">Cryptographie</label>
        </div><br>
